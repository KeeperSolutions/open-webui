...
WEBUI_URL = ConfigVar('WEBUI_URL', 'webui.url', validate_webui_url(os.environ.get('WEBUI_URL')))
...
ENABLE_TRUSTMINDER_FEEDBACK = (
    os.environ.get("ENABLE_TRUSTMINDER_FEEDBACK", "").lower() == "true"
)
