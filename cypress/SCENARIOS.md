...
| 10 | Select the shared model, send a prompt | User message echoed; response completes (`[aria-label="Edit"]` visible) | The non-admin chat path works end to end; model access grant is readable |
