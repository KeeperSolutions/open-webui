...
<div class="group relative bg-hg-bg-surface border border-hg-border rounded-[24px] shadow-[0px_4px_24px_-8px_rgba(0,0,0,0.06)] hover:border-hg-border-focus hover:shadow-[0px_0px_24px_-11px_rgba(33,45,72,0.4)] overflow-hidden flex flex-col w-full max-w-[300px] transition-[border-color,box-shadow] duration-200">
	<!-- Header -->
	<div class="relative p-4 flex flex-col gap-2">
		...
		{#if plan.isMostPopular}
			<div class="absolute top-4 right-4 inline-flex items-center px-2 py-1 rounded-hg-full bg-[#eff6ff] border border-[#bfdbfe]">
